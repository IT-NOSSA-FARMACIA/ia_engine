...
urlpatterns = [
    path("function/list/", login_required(FunctionListView.as_view()), name="function-list"),
    path("function/", login_required(FunctionView.as_view()), name="function"),
    path("function/<int:function_id>", login_required(FunctionView.as_view()), name="function"),
    path("function/<int:function_id>/customer", login_required(FunctionCustomerView.as_view()), name="function-customer"),
    path(
    ...
    path("customer/<int:customer_id>", login_required(CustomerView.as_view()), name="customer"),
]
